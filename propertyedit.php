            ...
            <div class="page-wrapper">
                <div class="content container-fluid">
					...
					<div class="page-header">
						<div class="row">
							<div class="col">
								<h3 class="page-title">WineYard</h3>
								<ul class="breadcrumb">
									<li class="breadcrumb-item"><a href="dashboard.php">Dashboard</a></li>
									<li class="breadcrumb-item active">WineYard</li>
								</ul>
							</div>
						</div>
					</div>
						...
						<div class="col-md-12">
							<div class="card">
								<div class="card-header">
									<h4 class="card-title">Update WineYard Details</h4>
									<?php echo $error; ?>
									<?php echo $msg; ?>
								</div>
								...
								<div class="card-body">
									<h5 class="card-title">WineYard Detail</h5>
										<div class="row">
											<div class="col-xl-12">
												...
												<div class="form-group row mb-3">
													...
													<div class="col-lg-9">
														<select class="form-control" required name="Option">
															...
															<option value="1 BHK">Open</option>
															<option value="1 BHK">Land</option>
