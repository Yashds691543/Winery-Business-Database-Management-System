    ...
    <div class="row"> 
        ...
        <div class="banner-full-row page-banner" style="background-image:url('images/breadcromb.jpg');">
            <div class="container">
                <div class="row">
                    <div class="col-md-6">
                        <h2 class="page-name float-left text-white text-uppercase mt-1 mb-0"><b>Wine Yard Detail</b></h2>
                    </div>
                    <div class="col-md-6">
                        <nav aria-label="breadcrumb" class="float-left float-md-right">
                            <ol class="breadcrumb bg-transparent m-0 p-0">
                                <li class="breadcrumb-item text-white"><a href="#">Home</a></li>
                                <li class="breadcrumb-item active">Wine Yard Detail</li>
                            </ol>
                        </nav>
                    </div>
                </div>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-8">
                        ...
                        <div class="property-details">
                            ...
                            <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Commodi dolorem beatae non perspiciatis aliquam dolore quas unde, voluptates expedita voluptatibus tenetur officia quasi esse, incidunt nihil, illo quia doloremque quam.</p>
                            <p><?php echo $row['2'];?></p>
                            
                            <h5 class="mt-5 mb-4 text-secondary">Wine Yard Summary</h5>
                    ...
                    <div class="col-lg-4">
                        ...
                        <form class="d-inline-block w-100" action="calc.php" method="post">
                            <label class="sr-only">Wineyard Amount</label>
                            <div class="input-group mb-2 mr-sm-2">
                                <div class="input-group-prepend">
                                    <div class="input-group-text">$</div>
                                </div>
                                <input type="text" class="form-control" name="amount" placeholder="Wineyard Price">
                            </div>
